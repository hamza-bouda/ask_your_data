...
Your task is to generate a highly accurate, read-only SQL query based on the user's question and the provided database schema.
...
6. When calculating metrics or dimensions, fill out the corresponding fields in the output accurately.
