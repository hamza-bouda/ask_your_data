...
class MockAsyncClient:
    ...
    async def post(self, url, json=None, headers=None, timeout=None, params=None):
        if "identity" in url:
        ...
        elif "orchestrator" in url or "conversations" in url:
...
@patch("backend.services.gateway.app.main.httpx.AsyncClient", new=MockAsyncClient)
...
def test_rate_limit_exceeded():
    ...
    async def mock_rate_limit_fail(*args, **kwargs):
